      ...
      <div className="flex flex-col xl:flex-row gap-12">
        ...
        <div className="flex-1 min-w-[300px]">
          ...
          <div className="grid grid-cols-7 gap-3 mb-6">
            {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map(d => (
              <div key={d} className="text-center text-xs font-bold text-slate-300 dark:text-slate-600 uppercase py-2">{d}</div>
            ))}
          ...
          {/* Legend */}
          <div className="flex gap-4 mt-auto pt-4 border-t border-slate-50 dark:border-dark-800">
            <div className="flex items-center gap-2">
              <div className="w-2.5 h-2.5 rounded-full bg-blue-400"></div>
              <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Checkup</span>
            </div>
            <div className="flex items-center gap-2">
