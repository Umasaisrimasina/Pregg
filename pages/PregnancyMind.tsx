      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-display font-extrabold text-slate-900 dark:text-dm-foreground">Prenatal Wellness</h1>
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-between max-w-md mx-auto mb-10">
                {[
                  ...
                  { key: 'good' as MoodType, icon: Smile, label: 'Good', color: 'bg-primary-100 text-primary-500' },
                ].map((item) => (
                  <div
                    key={item.key}
              ...
              <div className="relative mb-2">
                ...
                ></textarea>
                <button className="absolute bottom-4 right-4 p-2 bg-white rounded-full shadow-sm text-slate-400 hover:text-primary-500">
                  <Mic size={20} />
                </button>
              </div>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="bg-primary-500 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-lg shadow-primary-500/20 hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isAnalyzing ? (
                    <>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-dm-card rounded-[2rem] p-8 shadow-sm border border-slate-100 dark:border-dm-border">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-100 to-pink-100 flex items-center justify-center">
