          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Sleep', 'Work', 'Family', 'My Body', 'Diet'].map((tag, i) => (
                    <button key={i} className={`px-4 py-2 rounded-full text-sm border transition-colors ${tag === 'My Body' ? 'bg-emerald-50 border-emerald-200 text-emerald-700 font-medium' : 'border-slate-200 text-slate-600 hover:border-emerald-200'}`}>
                      {tag}
                    </button>
                  ))}
                </div>
              ...
              <div className="mt-6 flex justify-end">
                <button className="bg-emerald-600 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-lg shadow-emerald-600/20 hover:bg-emerald-700 transition-colors">
                  Save Entry
                </button>
              </div>
            </div>
